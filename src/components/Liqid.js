...
import liqidmobile3 from '../assets/images/liqid-mobile3.png'
import liqidlogo from '../assets/images/liqid-logo.svg'
    ...
    return (
        <div className='innerbg' ref={innermain}>
                    ...
                    <div className="detailsInnerHero__moreInfo">
                        ...
                        <div className="detailsInnerHero__moreInfo--text right_col">
                            <p className='split-text' data-splitting>
                                I joined the LIQID team to lead the revitalization of their online investment platform. I played a key role in shaping the brand's fresh direction, overseeing the artistic direction of new illustrations, charts, data infographics, fonts, and animation styles for the redesigned LIQID website.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="projectBanner">
                <div className="container">
                    <img className="img-slide" src={liqidbanner1} alt="" />
                </div>
            </div>
                    ...
                    <div className="detailsExplained__content">
                        ...
                        <div className="detailsExplained__text right_col">
                            <h2 className='split-text' data-splitting>
                                A cohesive brand identity and aesthetic for a leading online wealth management platform.
                            </h2>
                            <p className='split-text' data-splitting>
                                Through deep target market analysis and research, I directed the brand refresh, website design and interactive tools for LIQID, the highly anticipated wealth management company based in Berlin. I then handed my work over to the team of six internal designers to continue fleshing out the rest of the project. 
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="detailsBlock">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={liqidbanner2} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            Going bold – to make a statement. In the header section of the website, the logo would animate on scroll and reduce in size as the user goes down the page. Here, the focus was on a beautiful, graphic route and highlights important information.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsLogo">
                <div className="container">
                    <div className="detailsLogo__wrapper right_col">
                        <img className="img-slide" src={liqidlogo} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="mobileScreen__wrapper">
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={liqidmobile1} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={liqidmobile2} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={liqidmobile3} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsBlock bottomMargin">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={liqidbanner3} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            Selecting imagery for the upscale target audience involved careful curation to align with the platform's luxury positioning. The process focused on visuals that conveyed exclusivity and reflected the values of the discerning clientele, creating a narrative of prestige and opulence.
                        </p>
                    </div>
                </div>
            </div>
