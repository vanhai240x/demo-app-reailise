...
import wefoxbanner1 from '../assets/images/wefox-banner1.png'
import wefoxbanner2 from '../assets/images/wefox-banner2.png'
import wefoxbanner3 from '../assets/images/wefox-banner3.png'
import wefoxmobile1 from '../assets/images/wefox-mobile1.png'
import wefoxmobile2 from '../assets/images/wefox-mobile2.png'
import wefoxmobile3 from '../assets/images/wefox-mobile3.png'
import wefoxlogo from '../assets/images/wefox-logo-new.svg'
    ...
    return (
        <div className='innerbg' ref={innermain}>
                    ...
                    <div className="detailsInnerHero__headingWrapper">
                        <Marquee>
                            <h1 className="detailsInnerHero__projectHeading big innerBigText">
                                The rebirth of a loved fintech
                            </h1>
                        </Marquee>
                    </div>
                </div>
                    ...
                    <div className="detailsInnerHero__moreInfo">
                        ...
                        <div className="detailsInnerHero__moreInfo--text right_col">
                            <p className='split-text' data-splitting>
                                We rebranded the fintech “Finance Fox” to the now much loved “wefox”, enabling them to be very successful in their biggest investment round ever, just after the new design and digital experience was released. We then went on to brand and design their new products, One Insurance and Wefox Group.
            ...
            <div className="projectBanner">
                <div className="container">
                    <img className="img-slide" src={wefoxbanner1} alt="" />
                </div>
            </div>
                    ...
                    <div className="detailsExplained__content">
                        ...
                        <div className="detailsExplained__text right_col">
                            <h2 className='split-text' data-splitting>
                                The customer centric solution that builds connections and long lasting relationships.
                            </h2>
                            <p className='split-text' data-splitting>
                                We injected more emotion into the new Wefox branding. By using the word “we”, relationships
                                strengthened and customer success thrived. Then the next baby Wefox’s legacy was born, “One”
            ...
            <div className="detailsBlock">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={wefoxbanner2} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            Users are able to take out home insurance in three minutes. Now that’s what we call an easy, attractive and successful UX.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsLogo">
                <div className="container">
                    <div className="detailsLogo__wrapper right_col">
                        <img className="img-slide" src={wefoxlogo} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="mobileScreen__wrapper">
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={wefoxmobile1} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={wefoxmobile2} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={wefoxmobile3} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsBlock bottomMargin">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={wefoxbanner3} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            The wefox brand book shows off the simplistic, minimal yet unique aesthetic. A bold playful
                            colour pallette is friendly and catches the eye. We chose the primary orange colour as it’s
                            associated with joy, warmth and creativity, the perfect connotations for the wefox brand.
                        </p>
                    </div>
                </div>
            </div>
